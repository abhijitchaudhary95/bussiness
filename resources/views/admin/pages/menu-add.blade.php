        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_content">
                            {{ Form::open(['url'=>route('menu-post'),'class'=>'form','method'=>'post','enctype'=>'multipart/form-data']) }}
                            <div class="form-group row">
                                {{ Form::label('name','Food-Name:',['class'=>'col-sm-3']) }}
                                <div class="col sm-9">
                            ...
                            <div class="form-group row">
                                {{ Form::label('day','Day:',['class'=>'col-sm-3']) }}
                                <div class="col sm-9">
                                    {{ Form::text('day','',['class'=>'form-control','id'=>'day','required'=>true]) }}
                                </div>
                            </div>
